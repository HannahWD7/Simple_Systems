...
def gen_config_args_RES():
	...
	config_args['Bio_Cl_outflux'] = (False,float)
	config_args['Opp_Cl_outflux'] = (False, float)
	config_args['Bio_H_outflux'] = (False, float)
	config_args['Opp_H_outflux'] = (False, float)
	config_args['Bio_Cl_influx'] = (False,float)
	config_args['Opp_Cl_influx'] = (False, float)
	config_args['Bio_H_influx'] = (False, float)
	config_args['Opp_H_influx'] = (False, float)
	config_args['Net_Cl_outflux'] = (False, float)
	config_args['Net_H_outflux'] = (False, float)
	config_args['Net_Cl_influx'] = (False, float)
	config_args['Net_H_influx'] = (False, float)
	config_args['IV'] = (False, float)
	config_args['Bio_IV'] = (False, float)
	config_args['Opp_IV'] = (False, float)
	config_args['Orientation_preference'] = (False, float)
	n_required = 0
	for arg,properties in config_args.items():
		if properties[0]:
			n_required += 1
